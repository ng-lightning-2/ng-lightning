...
describe('Pagination Component', () => {
  ...
  describe('with limit settings', () => {
    const html = `<ngl-pagination [page]="page" [total]="total" limit="2"></ngl-pagination>`;
  ...
  describe('with `boundaryNumbers`', () => {
    const html = `<ngl-pagination [page]="page" boundaryNumbers="2" total="102" limit="3"></ngl-pagination>`;
